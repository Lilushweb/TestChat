...
import "./style/ourCapabilities.css"

export default function OurCapabilities() {
  return (
    <div className='capabilities'>

      <Block h='Создание увлекательного контента'
        text='Вы когда-нибудь мечтали написать интересную
       книгу или статью, но не знали, с чего начать?
        ChatGPT отлично справляется с генерацией
         текстов на любые темы. Опишите ему свою
          идею - и он создаст увлекательный контент,
           который захватит внимание читателей.'/>
      <Block h='Решение сложных задач'
      ...
      <Block h='Разработка и отладка кода'
      ...
      <Block h='Перевод текстов между языками'
      ...
      <Block h='Помощь в написании резюме'
      ...
      <Block h='Виртуальный помощник в жизни'
